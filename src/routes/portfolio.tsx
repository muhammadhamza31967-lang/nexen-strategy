        ...
        <section className="mx-auto max-w-[1400px] px-6 pt-16 pb-6 lg:px-12 lg:pt-24 lg:pb-8">
          ...
          <div className="mt-14 min-w-0 max-w-full lg:mt-20">
            ...
            <div className="pf-scroll -mx-6 min-w-0 max-w-[100vw] overflow-x-auto px-6 lg:mx-0 lg:max-w-full lg:overflow-visible lg:px-0">
              <div className="flex w-max min-w-full items-center justify-start gap-2 lg:w-full lg:flex-nowrap lg:justify-center lg:gap-2 xl:gap-3">
                {filters.map((f) => {
                  const on = f === active;
                  return (
                    <button
                      ...
                      aria-pressed={on}
                      className={cn(
                        "shrink-0 rounded-full border px-4 py-2.5 text-[0.72rem] font-semibold uppercase tracking-[0.12em] transition-all duration-300 lg:px-3.5 lg:text-[0.66rem] lg:tracking-[0.1em] xl:px-5 xl:text-[0.75rem]",
                        on
